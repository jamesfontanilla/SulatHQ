  ...
  return (
    <main className="auth-shell">
      <section className="auth-card">
        ...
        {mode !== "forgot" && <>
          <div className="oauth-divider" role="separator"><span>or</span></div>
          <button
            type="button"
          ...
          >
            <svg viewBox="0 0 24 24" aria-hidden="true">
              ...
              <path fill="#ea4335" d="M12 6.01c1.47 0 2.79.51 3.83 1.5l2.87-2.88A9.65 9.65 0 0 0 12 2a10 10 0 0 0-8.96 5.51l3.35 2.62C7.18 7.77 9.39 6.01 12 6.01Z"/>
            </svg>
